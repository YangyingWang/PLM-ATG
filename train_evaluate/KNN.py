...
def train(X_train, y_train):
    ...
    random_search = RandomizedSearchCV(knn, params, n_iter=50, cv=5, verbose=3, refit=True)
    ...
    joblib.dump(best_model, "D:/Major/AIProject/ATG/models/based_fasta/KNN_AADP_fasta.pkl")
    with open("D:/Major/AIProject/ATG/performance/KNN_results.txt", "a") as f:
        f.write(f"-------------------KNN OF AADP_FASTA--------------------\n")
