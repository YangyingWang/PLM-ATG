...
def train(X_train, y_train):
    ...
    random_search = RandomizedSearchCV(svm, params, n_iter=150, cv=5, verbose=3, refit=True)
    ...
    joblib.dump(best_model, "D:/Major/AIProject/ATG/models/based_pssm/SVM_DPC_pssm.pkl")
    with open("D:/Major/AIProject/ATG/performance/SVM_results.txt", "a") as f:
        f.write(f"-------------------SVM OF DPC_PSSM--------------------\n")
...
ne_train = 'D:/Major/AIProject/ATG/data/pssmdata/dpc_ne_train.csv'
po_train = 'D:/Major/AIProject/ATG/data/pssmdata/dpc_po_train.csv'
ne_test = 'D:/Major/AIProject/ATG/data/pssmdata/dpc_ne_test.csv'
po_test = 'D:/Major/AIProject/ATG/data/pssmdata/dpc_po_test.csv'
